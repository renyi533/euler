...
hadoop jar ./BinaryDataGen.jar BinaryDataGen -libjars /jar/fastjson-1.2.59.jar,/jar/graph_data_parser.jar -D mapred.job.priority=HIGH -D mapred.job.map.capacity=100 -D mapred.reduce.tasks=3 -D mapred.job.reduce.capacity=3 <input> <output> 10 
