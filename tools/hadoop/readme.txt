...
hadoop jar ./BinaryDataGen.jar BinaryDataGen -libjars /home/yi/jar/fastjson-1.2.59.jar,/home/yi/jar/graph_data_parser.jar -D mapred.job.priority=HIGH -D mapred.job.map.capacity=100 -D mapred.reduce.tasks=3 -D mapred.job.reduce.capacity=3  -D mapred.job.name='Json to Binary Conversion' -D mapreduce.reduce.java.opts=-Xmx4096M -D mapreduce.map.java.opts=-Xmx4096M -D yarn.cluster.name=xxx -D mapred.job.queue.name=xxx -D mapreduce.map.java.opts=-Xmx24000M  -D mapreduce.map.memory.mb=24000 -D mapreduce.reduce.memory.mb=12000 /home/yiren/ppi/input  /home/yiren/ppi/out2 4
